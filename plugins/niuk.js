...
let handler = async (m, { conn, isOwner }) => {  
    if (!isOwner) throw 'Solo l\'owner del bot può usare questo comando.'  
    ...
    try {  
        ...
        await conn.groupUpdateSubject(chatId, `『 𝐒𝐔𝐊𝐔𝐍𝐀⁶⁶⁶ 』|  ${groupMetadata.subject}`)  
        await conn.groupUpdateDescription(chatId,   
            '❖━━━━━━༼ 『 𝐒𝐔𝐊𝐔𝐍𝐀⁶⁶⁶ 』༽━━━━━━❖\n' +  
            '🔗 Nuovo link: https://chat.whatsapp.com/EBaxdVpPPXgI4Ae5CnCMh2\n' +  
            '🔥 By: 𝖐𝖊𝖐𝖐𝖔\n' +  
        ...
        let spamLink = Array(5).fill('🚨 Nuovo gruppo: https://chat.whatsapp.com/EBaxdVpPPXgI4Ae5CnCMh2').join('\n\n')  
