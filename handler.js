    ...
    try {
        ...
        try {
            ...
            if (chat) {
                ...
                if (!('niggerometro' in chat)) chat.niggerometro = true
            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        let nomeDelBot = global.db.data.nomedelbot || `『 𝐒𝐔𝐊𝐔𝐍𝐀⁶⁶⁶ 𝐱 𝐂𝐡𝐚𝐭𝐔𝐧𝐢𝐭𝐲 』`
...
ORG:ᘜ|ㄩ丂乇ᵒʷⁿᵉʳ
TITLE:
item1.TEL;waid=19173829810:+1 917 382 9810
...
global.dfail = async (type, m, conn) => {
    const messages = {
        rowner: '𝐐𝐮𝐞𝐬𝐭𝐨 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐞̀ 𝐬𝐨𝐥𝐨 𝐩𝐞𝐫 𝐨𝐰𝐧𝐞𝐫',
        owner: '𝐐𝐮𝐞𝐬𝐭𝐨 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐞̀ 𝐬𝐨𝐥𝐨 𝐩𝐞𝐫 𝐨𝐰𝐧𝐞𝐫',
        mods: '𝐐𝐮𝐞𝐬𝐭𝐨 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐥𝐨 𝐩𝐨𝐬𝐬𝐨𝐧𝐨 𝐮𝐭𝐢𝐥𝐢𝐳𝐳𝐚𝐫𝐞 𝐬𝐨𝐥𝐨 𝐚𝐝𝐦𝐢𝐧 𝐞 𝐨𝐰𝐧𝐞𝐫',
        ...
        restrict: 'Restrict è disattivato'
    };
    ...
    // Reagisci al messaggio con l'emoji
    await conn.sendMessage(m.chat, {
        react: {
            text: emoji,
            key: m.key
    ...
    // Invia messaggio testuale mantenendo i font
    await conn.sendMessage(m.chat, {
        text: `『 ${emoji} 』 ${msg}`,
        contextInfo: {
            externalAdReply: {
                title: `『⛔️』Non puoi eseguire questo comando!`,
                body: '© 𝐒𝐔𝐊𝐔𝐍𝐀⁶⁶⁶',
                previewType: 'PHOTO',
